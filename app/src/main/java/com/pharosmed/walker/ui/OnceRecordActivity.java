...
import com.pharosmed.walker.customview.ChartOnceMarkerView;
import com.pharosmed.walker.customview.ChartTodayMarkerView;
...
public class OnceRecordActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        trainDataEntityList = TrainDataManager.getInstance().getTrainDataByDateAndFrequency(SPHelper.getUserId(),numOfTimeBean.getDateSte(),numOfTimeBean.getFrequency() - 1);
    }
...
//        xAxis.setCenterAxisLabels(true);
    ...
    private void setChartDatas(List<TrainDataEntity> lists) {
        ...
        if (lists != null && lists.size() > 0) {
            ...
            LimitLine ll3 = new LimitLine(lists.get(0).getTargetLoad() * 1.5f, "最大负重");
            ll3.setLineWidth(2f);
