...
import com.pharosmed.walker.adapter.AgeArrayAdapter;
...
import com.pharosmed.walker.utils.RegexUtils;
...
//            userBean.setRemark(txtDiag.getText().toString());
            ...
            if (mUserManager.isUniqueValue(caseHistoryNum,mode)){
                try {
                    ...
                    if (e.getMessage().contains("UNIQUE constraint failed: USER.CASE_HISTORY_NO")){
