...
import com.pharosmed.walker.greendao.DaoMaster;
import com.pharosmed.walker.greendao.DaoSession;
...
public class GreenDaoHelper {
    ...
    public static class MyOpenHelper extends DaoMaster.OpenHelper {
        ...
        public void onUpgrade(Database db, int oldVersion, int newVersion) {
            ...
            },  UserBeanDao.class, PlanEntityDao.class, SubPlanEntityDao.class, UserTrainRecordEntityDao.class, EvaluateEntityDao.class, TrainDataEntityDao.class);
        }
    }
