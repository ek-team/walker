...
import com.pharosmed.walker.constants.RegexConstants;
...
public final class RegexUtils {
    ...
    public static int getNumFromString(String content){
        ...
        if (cs.length == 0){
            ...
            return Integer.parseInt(cs[cs.length - 1]);
        }
    }
    /**
    ...
    public static boolean isName(final CharSequence input) {
