...
public abstract class Gauge extends View {
    ...
    public ValueAnimator speedAnimator, trembleAnimator, realSpeedAnimator;
    ...
    /** draw speed text as <b>.1 float</b>. */
    public static final byte FLOAT_FORMAT_3 = 3;
    /** number of decimal places */
    public int speedTextFormat = FLOAT_FORMAT;
    /** number of decimal places */
    ...
    public enum Position {
        ...
        , BOTTOM_CENTER (.5f , .93f  , .5f , 1f  , 0  , -1)
